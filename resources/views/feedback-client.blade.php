                                        ...
                                        <div class="card-body mb-3">
                                            ...
                                            <form action="/feedback/{{ $form->id }}" method="POST">
                                                ...
                                                <div class="form-group mb-4">
                                                    ...
                                                    <span
                                                        class="error-message text-danger">{{ $errors->first('name') }}</span>
                                                </div>
                                                <div class="form-group mb-4">
                                                    <input type="text" class="form-control" id="position"
                                                        name="position" placeholder="Jobs / Position" required
                                                ...
                                                <div class="d-grid">
                                                    <button type="submit" class="btn btn-block btn-dark py-2">Rate
                                                        now</button>
                                                </div>
                                            </form>
                                        </div>
